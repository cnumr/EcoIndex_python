...
| API, Worker         | `SENTRY_DSN`               | ``                                 | If you want to use [Sentry](https://sentry.io/) to monitor your application, set this variable with your project DSN. The legacy `GLITCHTIP_DSN` variable is still supported for backward compatibility.                                                                                                                                                                                                                    |
